...
Спасибо, в этой работе у вас все реализовано замечательно, никаких ошибок нет.

Отлично, что с доп. заданиями :)

Только не совсем понял, зачем вам в первой задаче вообще цикл, ведь индексы можно вычислять без него на основе длины слова, без перебора:
...
А в задаче с парами можно было использовать zip, чтобы не прибегать к вспомогательному счетчику:
